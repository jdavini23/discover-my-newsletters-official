...
import Footer from '@/component/s/commo/n/Footer';/
import HomeCTA from '@/component/s/hom/e/HomeCTA';/
import HomeFeatures from '@/component/s/hom/e/HomeFeatures';/
import { HomeSearchBar } from '@/component/s/hom/e/HomeSearchBar';/
