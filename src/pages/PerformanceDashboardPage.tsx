    ...
    >
      <div className="flex justify-between items-center mb-4">
        ...
        {trend && (
          ...
          `}>
            <TrendingUpIcon className={`w-5 h-5 mr-1 ${trend === 'down' ? 'transform rotate-180' : ''}`} />
            <span className="text-sm">{trend === 'up' ? 'Improving' : trend === 'down' ? 'Declining' : 'Stable'}</span>
          </div>
        )}
      </div>
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <PerformanceMetricCard 
          ...
          trend={performanceData.systemPerformance.recommendationGenerationTime < 100 ? 'up' : 'down'}
        />
      </div>
