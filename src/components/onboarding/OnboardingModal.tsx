...
const NEWSLETTER_CATEGORIES = [
  'Technology', 'Science', 'Business', 'Design', 
  'Health', 'Finance', 'Environment', 'AI', 
  'Startups', 'Innovation', 'Culture', 'Politics'
];
        ...
        return (
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-4">
              {[SparklesIcon, MagnifyingGlassIcon, HeartIcon, UserGroupIcon].map((Icon, idx) => (
