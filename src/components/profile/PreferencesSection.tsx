    ...
    <div className='bg-white shadow-md rounded-lg p-4 sm:p-6'>
      ...
      <div className='mb-4 sm:mb-6'>
        ...
        <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-1 sm:gap-2'>
          {NEWSLETTER_TOPICS.map((topic) => (
            <label
              key={topic}
              className={`flex items-center space-x-1 sm:space-x-2 p-1 sm:p-2 rounded-md cursor-pointer text-xs sm:text-sm ${
        ...
        <div className='flex space-x-2 sm:space-x-4'>
          {['daily', 'weekly', 'monthly'].map((freq) => (
            <button
              ...
              className={`px-2 py-1 sm:px-4 sm:py-2 rounded-md capitalize text-xs sm:text-base ${
      ...
      <div className='flex justify-end'>
        <button
          ...
          className='px-3 py-1 sm:px-4 sm:py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 text-xs sm:text-base'
        >
          Save Preferences
        </button>
      </div>
