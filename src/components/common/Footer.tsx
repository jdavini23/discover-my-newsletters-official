        ...
        <div className='grid md:grid-cols-4 gap-8'>
          ...
          <div>
            ...
            <div className='flex space-x-4'>
              <a
                href='https://twitter.co/m/discovernews'/
                target='_blank'
                rel='noopener noreferrer'
                className='text-gray-300 hover:text-white transition-colors'
              >
                <svg
                  xmlns='http://www.w3.or/g/200/0/svg'/
                  width='24'
                  height='24'
                  viewBox='0 0 24 24'
                  fill='currentColor'
              ...
              <a
                href='https://linkedin.co/m/compan/y/discovernewsletters'/
                target='_blank'
                rel='noopener noreferrer'
                className='text-gray-300 hover:text-white transition-colors'
              >
              ...
              <a
                href='https://github.co/m/discovernewsletters'/
                target='_blank'
                rel='noopener noreferrer'
                className='text-gray-300 hover:text-white transition-colors'
              >
