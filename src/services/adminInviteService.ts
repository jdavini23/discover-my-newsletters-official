...
const ADMIN_INVITE_CONFIG = {
  ...
  MAX_INVITE_USES: 5,
  INVITE_CODE_EXPIRY_DAYS: 30, // Invite codes expire after 30 days
};
...
export class AdminInviteService {
  ...
  static async getAdminInviteCodes(
    options: {
      limit?: number;
      createdBy?: string;
      activeOnly?: boolean;
...
// Export configuration for potential use in other parts of the application
