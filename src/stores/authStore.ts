...
export type AuthActions = {
    ...
    register: (email: string, password: string, additionalData?: Partial<UserProfile>) => Promise<void>;
    logout: () => Promise<void>;
...
const useAuthStore = create<AuthState & AuthActions>()(devtools(persist(immer((set) => {
