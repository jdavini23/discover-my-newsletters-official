...
const INTERACTION_CONFIG = {
    ...
    interactionTypes: ['view', 'subscribe', 'read']
};
    ...
    try {
        ...
        userIds.forEach(userId => {
            ...
            selectedNewsletters.forEach(newsletter => {
                ...
                const interactionType = INTERACTION_CONFIG.interactionTypes[Math.floor(Math.random() * INTERACTION_CONFIG.interactionTypes.length)];
                const timestamp = randomDate(new Date(2024, 0, 1), // Start of 2024
